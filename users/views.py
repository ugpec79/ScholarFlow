...
)  # Assuming this is the function to fetch recommendations
...
def log_user_action(
    user_id, paper_id, action, comment=None, file_path="user_actions.csv"
):
    ...
    print(
        f"✅ Logged: {user_id} | {paper_id} | {action} | {comment if comment else 'N/A'}"
    )
